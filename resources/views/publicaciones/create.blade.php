...
<body class="bg-gradient-to-br from-slate-50 to-indigo-100 min-h-screen font-sans flex items-center justify-center py-12">
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl p-10">
        <h1 class="text-3xl font-bold text-center text-indigo-800 mb-8">Crear Nueva Publicación</h1>
        ...
        <form action="{{ route('publicaciones.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="cuerpo" id="cuerpo" required rows="4"
                          class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"></textarea>
            </div>
